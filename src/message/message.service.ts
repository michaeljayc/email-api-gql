...
export class MessageService {
  ...
  //     filtered: TFilteredQuery,
  //   ): Promise<rethink.WriteResult> {
  //     return this.databaseService.getByFilter(DB, TABLE, filtered);
  //   }

  //   async sendMessage(message: Message): Promise<rethink.WriteResult> {
  //     return this.databaseService.insertRecord(DB, TABLE, message);
  //   }

  //   async updateReadUnread(message_id: string, data: Message): Promise<any> {
  ...
  //   async deleteMessage(message_id: string): Promise<rethink.WriteResult> {
  //     return this.databaseService.deleteRecord(DB, TABLE, message_id);
  //   }

  //   async checkMessageInMenu(query: any): Promise<rethink.WriteResult> {
